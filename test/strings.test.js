...
describe('Testing string representation functions', () => {
    it('ReturnStatement:', () => {
        ...
        var program =  {type: 'FunctionDeclaration', id: {type:'Identifier', name:'f'}, params: [],
            body: [{type:'BlockStatement', body: [{type:'ReturnStatement', value: 'a'}]}]
        };
        assert.equal(
            JSON.stringify(strings.findStringRepresentation(program.body[0].body[0])),
            '"a"'
        );
    });
});
...
describe('Testing string representation functions', () => {
    it('Error:', () => {
        ...
        var program =  {type: 'FunctionDeclaration2', id: {type:'Identifier2', name:'f'}, params: [],
            body: [{type:'BlockStatement2', body: [{type:'ReturnStatemen2t', value: 'a'}]}]
        };
        assert.equal(
            JSON.stringify(strings.findStringRepresentation(program.body[0].body[0])),
            '""'
